...
// predict
int predict(Rcpp::CharacterVector infile0, Rcpp::CharacterVector outfile0, Rcpp::CharacterVector outfile_expr0, int locus_model, double up_bound, int match_mode, int write_flag);
RcppExport SEXP _scBIRD_predict(SEXP infile0SEXP, SEXP outfile0SEXP, SEXP outfile_expr0SEXP, SEXP locus_modelSEXP, SEXP up_boundSEXP, SEXP match_modeSEXP, SEXP write_flagSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(predict(infile0, outfile0, outfile_expr0, locus_model, up_bound, match_mode, write_flag));
